  ...
  return (
    ...
    >
      <div
        ...
        className={`relative z-10 min-h-screen bg-black px-[10px] py-[10px] sm:px-[18px] sm:py-[18px] ${dismissGesture.motionClassName}`}
      ...
      >
        ...
        {image !== null && (
          <main className="relative z-10 mx-auto flex min-h-[calc(100vh-20px)] sm:min-h-[calc(100vh-36px)] max-w-6xl flex-col justify-center gap-4">
            <h1
